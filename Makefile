...
osc: osc-api/outscale.yaml
	rm -rf .sdk || true
	mkdir .sdk
	docker run -e GO_POST_PROCESS_FILE="/usr/local/bin/gofmt -w" -v $(PWD):/sdk --rm openapitools/openapi-generator-cli:latest generate -i /sdk/osc-api/outscale.yaml -g go -c /sdk/gen.yml -o /sdk/.sdk
	mv .sdk osc
