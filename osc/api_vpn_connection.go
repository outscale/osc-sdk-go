...
type UpdateVpnConnectionOpts struct {
	UpdateVpnConnectionRequest optional.Interface
}
...
func (a *VpnConnectionApiService) UpdateVpnConnection(ctx _context.Context, localVarOptionals *UpdateVpnConnectionOpts) (UpdateVpnConnectionResponse, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UpdateVpnConnection"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.UpdateVpnConnectionRequest.IsSet() {
		localVarOptionalUpdateVpnConnectionRequest, localVarOptionalUpdateVpnConnectionRequestok := localVarOptionals.UpdateVpnConnectionRequest.Value().(UpdateVpnConnectionRequest)
		if !localVarOptionalUpdateVpnConnectionRequestok {
			return localVarReturnValue, nil, reportError("updateVpnConnectionRequest should be UpdateVpnConnectionRequest")
		}
		localVarPostBody = &localVarOptionalUpdateVpnConnectionRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v UpdateVpnConnectionResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
