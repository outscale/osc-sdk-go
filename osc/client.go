...
// APIClient manages communication with the 3DS OUTSCALE API API v1.0
...
type APIClient struct {
	...
	AccountPasswordApi *AccountPasswordApiService
	...
	ResetPasswordEmailApi *ResetPasswordEmailApiService

	RouteApi *RouteApiService

	RouteTableApi *RouteTableApiService

	SecretAccessKeysApi *SecretAccessKeysApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.AccountPasswordApi = (*AccountPasswordApiService)(&c.common)
	...
	c.ResetPasswordEmailApi = (*ResetPasswordEmailApiService)(&c.common)
	c.RouteApi = (*RouteApiService)(&c.common)
	c.RouteTableApi = (*RouteTableApiService)(&c.common)
	c.SecretAccessKeysApi = (*SecretAccessKeysApiService)(&c.common)
...
func (c *APIClient) decode(v interface{}, b []byte, contentType string) (err error) {
	...
	if jsonCheck.MatchString(contentType) || contentType == "text/plain" {
...
func setBody(body interface{}, contentType string) (bodyBuf *bytes.Buffer, err error) {
	...
	if reader, ok := body.(io.Reader); ok {
		...
		_, err = bodyBuf.WriteString(*s)
	} else if jsonCheck.MatchString(contentType) || contentType == "text/plain" {
