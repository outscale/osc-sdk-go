...
// SecretAccessKeysApiService SecretAccessKeysApi service
type SecretAccessKeysApiService service
...
*/
func (a *SecretAccessKeysApiService) ReadSecretAccessKey(ctx _context.Context, localVarOptionals *ReadSecretAccessKeyOpts) (ReadSecretAccessKeyResponse, *_nethttp.Response, error) {
	var (
