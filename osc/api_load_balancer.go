...
type LinkLoadBalancerBackendMachinesOpts struct {
	LinkLoadBalancerBackendMachinesRequest optional.Interface
}

/*
LinkLoadBalancerBackendMachines Method for LinkLoadBalancerBackendMachines
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LinkLoadBalancerBackendMachinesOpts - Optional Parameters:
 * @param "LinkLoadBalancerBackendMachinesRequest" (optional.Interface of LinkLoadBalancerBackendMachinesRequest) -
@return LinkLoadBalancerBackendMachinesResponse
*/
func (a *LoadBalancerApiService) LinkLoadBalancerBackendMachines(ctx _context.Context, localVarOptionals *LinkLoadBalancerBackendMachinesOpts) (LinkLoadBalancerBackendMachinesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/LinkLoadBalancerBackendMachines"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.LinkLoadBalancerBackendMachinesRequest.IsSet() {
		localVarOptionalLinkLoadBalancerBackendMachinesRequest, localVarOptionalLinkLoadBalancerBackendMachinesRequestok := localVarOptionals.LinkLoadBalancerBackendMachinesRequest.Value().(LinkLoadBalancerBackendMachinesRequest)
		if !localVarOptionalLinkLoadBalancerBackendMachinesRequestok {
		...
		localVarPostBody = &localVarOptionalLinkLoadBalancerBackendMachinesRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v LinkLoadBalancerBackendMachinesResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
type UnlinkLoadBalancerBackendMachinesOpts struct {
	UnlinkLoadBalancerBackendMachinesRequest optional.Interface
}

/*
UnlinkLoadBalancerBackendMachines Method for UnlinkLoadBalancerBackendMachines
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UnlinkLoadBalancerBackendMachinesOpts - Optional Parameters:
 * @param "UnlinkLoadBalancerBackendMachinesRequest" (optional.Interface of UnlinkLoadBalancerBackendMachinesRequest) -
@return UnlinkLoadBalancerBackendMachinesResponse
*/
func (a *LoadBalancerApiService) UnlinkLoadBalancerBackendMachines(ctx _context.Context, localVarOptionals *UnlinkLoadBalancerBackendMachinesOpts) (UnlinkLoadBalancerBackendMachinesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UnlinkLoadBalancerBackendMachines"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.UnlinkLoadBalancerBackendMachinesRequest.IsSet() {
		localVarOptionalUnlinkLoadBalancerBackendMachinesRequest, localVarOptionalUnlinkLoadBalancerBackendMachinesRequestok := localVarOptionals.UnlinkLoadBalancerBackendMachinesRequest.Value().(UnlinkLoadBalancerBackendMachinesRequest)
		if !localVarOptionalUnlinkLoadBalancerBackendMachinesRequestok {
			return localVarReturnValue, nil, reportError("unlinkLoadBalancerBackendMachinesRequest should be UnlinkLoadBalancerBackendMachinesRequest")
		}
		localVarPostBody = &localVarOptionalUnlinkLoadBalancerBackendMachinesRequest
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 200 {
			var v UnlinkLoadBalancerBackendMachinesResponse
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
