...
// ResetPasswordEmailApiService ResetPasswordEmailApi service
type ResetPasswordEmailApiService service
...
*/
func (a *ResetPasswordEmailApiService) SendResetPasswordEmail(ctx _context.Context, localVarOptionals *SendResetPasswordEmailOpts) (SendResetPasswordEmailResponse, *_nethttp.Response, error) {
	var (
