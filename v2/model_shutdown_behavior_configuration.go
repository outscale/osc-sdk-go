...
type ShutdownBehaviorConfiguration struct {
	...
	GuestAction *string `json:"GuestAction,omitempty"`
	...
	HostAction *string `json:"HostAction,omitempty"`
}
...
func NewShutdownBehaviorConfiguration() *ShutdownBehaviorConfiguration {
	this := ShutdownBehaviorConfiguration{}
	return &this
}
...
// GetGuestAction returns the GuestAction field value if set, zero value otherwise.
func (o *ShutdownBehaviorConfiguration) GetGuestAction() string {
	if o == nil || o.GuestAction == nil {
		var ret string
		return ret
	}
	return *o.GuestAction
}

// GetGuestActionOk returns a tuple with the GuestAction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ShutdownBehaviorConfiguration) GetGuestActionOk() (*string, bool) {
	if o == nil || o.GuestAction == nil {
		return nil, false
	}
	return o.GuestAction, true
}
...
// SetGuestAction gets a reference to the given string and assigns it to the GuestAction field.
func (o *ShutdownBehaviorConfiguration) SetGuestAction(v string) {
	o.GuestAction = &v
}

// GetHostAction returns the HostAction field value if set, zero value otherwise.
func (o *ShutdownBehaviorConfiguration) GetHostAction() string {
	if o == nil || o.HostAction == nil {
		var ret string
		return ret
	}
	return *o.HostAction
...
// GetHostActionOk returns a tuple with the HostAction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ShutdownBehaviorConfiguration) GetHostActionOk() (*string, bool) {
	if o == nil || o.HostAction == nil {
		return nil, false
	}
	return o.HostAction, true
}
...
// SetHostAction gets a reference to the given string and assigns it to the HostAction field.
func (o *ShutdownBehaviorConfiguration) SetHostAction(v string) {
	o.HostAction = &v
}

func (o ShutdownBehaviorConfiguration) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.GuestAction != nil {
		toSerialize["GuestAction"] = o.GuestAction
	}
	if o.HostAction != nil {
		toSerialize["HostAction"] = o.HostAction
	}
	return json.Marshal(toSerialize)
}

type NullableShutdownBehaviorConfiguration struct {
	value *ShutdownBehaviorConfiguration
	isSet bool
}

func (v NullableShutdownBehaviorConfiguration) Get() *ShutdownBehaviorConfiguration {
	return v.value
}

func (v *NullableShutdownBehaviorConfiguration) Set(val *ShutdownBehaviorConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableShutdownBehaviorConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableShutdownBehaviorConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShutdownBehaviorConfiguration(val *ShutdownBehaviorConfiguration) *NullableShutdownBehaviorConfiguration {
	return &NullableShutdownBehaviorConfiguration{value: val, isSet: true}
}

func (v NullableShutdownBehaviorConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShutdownBehaviorConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
