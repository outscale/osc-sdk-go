...
type FiltersApiLog struct {
	...
	QueryDateAfter *time.Time `json:"QueryDateAfter,omitempty"`
	...
	QueryDateBefore *time.Time `json:"QueryDateBefore,omitempty"`
...
// SetQueryDateAfter gets a reference to the given time.Time and assigns it to the QueryDateAfter field.
...
// SetQueryDateBefore gets a reference to the given time.Time and assigns it to the QueryDateBefore field.
