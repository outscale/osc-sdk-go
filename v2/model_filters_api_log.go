...
// SetQueryDateAfter gets a reference to the given OneOfDateTimedate and assigns it to the QueryDateAfter field.
...
// SetQueryDateBefore gets a reference to the given OneOfDateTimedate and assigns it to the QueryDateBefore field.
