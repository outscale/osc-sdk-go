...
type CreateSecurityGroupRuleRequest struct {
	...
	// The OUTSCALE account ID that owns the source or destination security group specified in the `SecurityGroupNameToLink` parameter.<br />With OSC CLI, you must wrap the value in two pairs of quotes to make sure it is parsed as a string: `--SecurityGroupAccountIdToLink '&quot;12345678&quot;'`.
