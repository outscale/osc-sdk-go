...
**SecurityGroupAccountIdToLink** | Pointer to **string** | The OUTSCALE account ID that owns the source or destination security group specified in the &#x60;SecurityGroupNameToLink&#x60; parameter.&lt;br /&gt;With OSC CLI, you must wrap the value in two pairs of quotes to make sure it is parsed as a string: &#x60;--SecurityGroupAccountIdToLink &#39;&amp;quot;12345678&amp;quot;&#39;&#x60;. | [optional] 
**SecurityGroupId** | **string** | The ID of the security group for which you want to create a rule. | 
**SecurityGroupNameToLink** | Pointer to **string** | The ID of a source or destination security group that you want to link to the security group of the rule. | [optional] 
