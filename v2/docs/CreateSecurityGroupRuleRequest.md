...
**SecurityGroupAccountIdToLink** | Pointer to **string** | The OUTSCALE account ID that owns the source or destination security group specified in the &#x60;SecurityGroupNameToLink&#x60; parameter. | [optional] 
