...
**Scope** | Pointer to **string** | The scope of the policies. A policy can either be created by Outscale (&#x60;OWS&#x60;), and therefore applies to all accounts, or be created by its users (&#x60;LOCAL&#x60;). | [optional] 
