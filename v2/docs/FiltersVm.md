...
**NicLinkNicVmAccountIds** | Pointer to **[]string** | The OUTSCALE account IDs of the owners of the VMs the NICs are attached to. | [optional] 
**NicLinkNicVmIds** | Pointer to **[]string** | The IDs of the VMs the NICs are attached to. | [optional] 
**NicLinkPublicIpAccountIds** | Pointer to **[]string** | The OUTSCALE account IDs of the owners of the public IPs associated with the NICs. | [optional] 
...
**NicPrivateIpsLinkPublicIpAccountIds** | Pointer to **[]string** | The OUTSCALE account IDs of the owner of the public IPs associated with the private IPs. | [optional] 
