...
------------ | ------------- | ------------- | -------------
**ExpirationDate** | Pointer to **string** | The date on which the server certificate expires. | [optional] 
...
**UploadDate** | Pointer to **string** | The date on which the server certificate has been uploaded. | [optional] 
