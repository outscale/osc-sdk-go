...
------------ | ------------- | ------------- | -------------
**ExpirationDate** | Pointer to **string** | The date and time (UTC) on which the server certificate expires. | [optional] 
...
**UploadDate** | Pointer to **string** | The date and time (UTC) on which the server certificate has been uploaded. | [optional] 
