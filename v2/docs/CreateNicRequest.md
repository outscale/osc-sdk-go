...
**PrivateIps** | Pointer to [**[]PrivateIpLight**](PrivateIpLight.md) | Information about the private IP or IPs of the NIC. If you do not specify a primary private IP, one is still created, with an IP randomly selected within the IP range of the Subnet. | [optional] 
