...
**LinkNicVmAccountIds** | Pointer to **[]string** | The OUTSCALE account IDs of the owners of the VMs the NICs are attached to. | [optional] 
**LinkNicVmIds** | Pointer to **[]string** | The IDs of the VMs the NICs are attached to. | [optional] 
**LinkPublicIpAccountIds** | Pointer to **[]string** | The OUTSCALE account IDs of the owners of the public IPs associated with the NICs. | [optional] 
...
**PrivateDnsNames** | Pointer to **[]string** | The private DNS names associated with the primary private IPs. | [optional] 
**PrivateIpsLinkPublicIpAccountIds** | Pointer to **[]string** | The OUTSCALE account IDs of the owner of the public IPs associated with the private IPs. | [optional] 
**PrivateIpsLinkPublicIpPublicIps** | Pointer to **[]string** | The public IPs associated with the private IPs. | [optional] 
**PrivateIpsPrimaryIp** | Pointer to **bool** | Whether the private IP is the primary IP associated with the NIC. | [optional] 
**PrivateIpsPrivateIps** | Pointer to **[]string** | The private IPs of the NICs. | [optional] 
