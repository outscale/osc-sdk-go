...
func (o UpdateMasterKeyResponse) MarshalJSON() ([]byte, error) {
...
type NullableUpdateMasterKeyResponse struct {
	value *UpdateMasterKeyResponse
	isSet bool
}

func (v NullableUpdateMasterKeyResponse) Get() *UpdateMasterKeyResponse {
	return v.value
}

func (v *NullableUpdateMasterKeyResponse) Set(val *UpdateMasterKeyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateMasterKeyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateMasterKeyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateMasterKeyResponse(val *UpdateMasterKeyResponse) *NullableUpdateMasterKeyResponse {
	return &NullableUpdateMasterKeyResponse{value: val, isSet: true}
}

func (v NullableUpdateMasterKeyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateMasterKeyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
