...
type CreateAccountRequest struct {
	...
	// The ID of the customer. It must be 8 digits.<br />With OSC CLI, you must wrap this value in two pairs of quotes to make sure it is parsed as a string: `--CustomerId '&quot;12345678&quot;'`.
	...
	// The ZIP code of the city.<br />With OSC CLI, you must wrap this value in two pairs of quotes to make sure it is parsed as a string: `--ZipCode '&quot;12345678&quot;'`.
