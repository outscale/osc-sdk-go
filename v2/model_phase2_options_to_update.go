...
func (o Phase2OptionsToUpdate) MarshalJSON() ([]byte, error) {
...
type NullablePhase2OptionsToUpdate struct {
	value *Phase2OptionsToUpdate
	isSet bool
}

func (v NullablePhase2OptionsToUpdate) Get() *Phase2OptionsToUpdate {
	return v.value
}

func (v *NullablePhase2OptionsToUpdate) Set(val *Phase2OptionsToUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullablePhase2OptionsToUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullablePhase2OptionsToUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhase2OptionsToUpdate(val *Phase2OptionsToUpdate) *NullablePhase2OptionsToUpdate {
	return &NullablePhase2OptionsToUpdate{value: val, isSet: true}
}

func (v NullablePhase2OptionsToUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhase2OptionsToUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
