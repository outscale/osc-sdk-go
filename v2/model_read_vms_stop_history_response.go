...
// ReadVmsStopHistoryResponse struct for ReadVmsStopHistoryResponse
type ReadVmsStopHistoryResponse struct {
	...
	// Information about the VM(s) stop history.
...
func NewReadVmsStopHistoryResponse() *ReadVmsStopHistoryResponse {
	this := ReadVmsStopHistoryResponse{}
	return &this
}
...
// GetVmsStopHistory returns the VmsStopHistory field value if set, zero value otherwise.
func (o *ReadVmsStopHistoryResponse) GetVmsStopHistory() []VmsStopHistory {
	if o == nil || o.VmsStopHistory == nil {
		var ret []VmsStopHistory
		return ret
	}
	return *o.VmsStopHistory
}

// GetVmsStopHistoryOk returns a tuple with the VmsStopHistory field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReadVmsStopHistoryResponse) GetVmsStopHistoryOk() (*[]VmsStopHistory, bool) {
	if o == nil || o.VmsStopHistory == nil {
		return nil, false
	}
	return o.VmsStopHistory, true
}
...
// SetVmsStopHistory gets a reference to the given []VmsStopHistory and assigns it to the VmsStopHistory field.
func (o *ReadVmsStopHistoryResponse) SetVmsStopHistory(v []VmsStopHistory) {
	o.VmsStopHistory = &v
}

func (o ReadVmsStopHistoryResponse) MarshalJSON() ([]byte, error) {
	...
	if o.VmsStopHistory != nil {
		toSerialize["VmsStopHistory"] = o.VmsStopHistory
	}
	return json.Marshal(toSerialize)
}

type NullableReadVmsStopHistoryResponse struct {
	value *ReadVmsStopHistoryResponse
	isSet bool
}

func (v NullableReadVmsStopHistoryResponse) Get() *ReadVmsStopHistoryResponse {
	return v.value
}

func (v *NullableReadVmsStopHistoryResponse) Set(val *ReadVmsStopHistoryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReadVmsStopHistoryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReadVmsStopHistoryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadVmsStopHistoryResponse(val *ReadVmsStopHistoryResponse) *NullableReadVmsStopHistoryResponse {
	return &NullableReadVmsStopHistoryResponse{value: val, isSet: true}
}

func (v NullableReadVmsStopHistoryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadVmsStopHistoryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
